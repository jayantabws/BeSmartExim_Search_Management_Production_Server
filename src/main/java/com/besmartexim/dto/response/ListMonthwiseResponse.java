...
public class ListMonthwiseResponse {
	
	List<ListMonthwise> monthwiseList;
	...
	public List<ListMonthwise> getMonthwiseList() {
		return monthwiseList;
	}

	public void setMonthwiseList(List<ListMonthwise> monthwiseList) {
